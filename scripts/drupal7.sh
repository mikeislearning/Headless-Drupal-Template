...
drush -y dl admin admin_menu adminimal_admin_menu backup_migrate breakpoints ckeditor cors ctools date entity entityreference entity_translation features field_collection field_group i18n instantfilter libraries link media metatag multifield pathauto picture restws rules scheduler services services_views services_menu site_map strongarm transliteration tmgmt token variable views viewfield views_field_view views_bulk_operations views_contextual_filter_query
