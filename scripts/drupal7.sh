...
drush -y dl admin admin_menu adminimal_admin_menu addressfield backup_migrate better_exposed_filters breakpoints ckeditor cors ctools date dba devel enterprise_base entity entity_translation entityconnect entityqueue entityreference features field_collection field_group geolocation gmap i18n instantfilter libraries link location media media_vimeo media_youtube metatag multifield pathauto picture restws rules scheduler services services_views services_menu site_map strongarm tablefield transliteration tmgmt token variable viewfield views views_bulk_operations views_contextual_filter_query views_datasource views_field_view views_fieldset

# Enable Drupal modules
drush -y en admin admin_devel admin_menu adminimal_admin_menu addressfield backup_migrate better_exposed_filters breakpoints ckeditor cors ctools date date_popup dba devel enterprise_base entity entity_translation entity_translation_i18n_menu entity_translation_upgrade entityconnect entityqueue entityreference features field_collection field_group geolocation gmap i18n i18n_block i18n_contact i18n_field i18n_menu i18n_node i18n_path i18n_select i18n_taxonomy i18n_variable instantfilter libraries location link media media_internet media_vimeo media_youtube metatag multifield pathauto picture rest_server restws rules rules_admin rules_i18n rules_scheduler scheduler services services_views services_menu site_map strongarm tablefield tmgmt tmgmt_field tmgmt_language_combination tmgmt_entity tmgmt_entity_ui tmgmt_i18n_string tmgmt_local tmgmt_locale tmgmt_node tmgmt_node_ui tmgmt_ui token transliteration variable variable_admin variable_realm variable_store variable_views views views_field_view views_fieldset views_json views_ui views_bulk_operations views_contextual_filter_query viewfield
